...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, NgxMaskDirective, ReactiveFormsModule, ButtonComponent],
...
export class RegisterUserFormComponent {
    ...
    submit() {
        ...
        this.errorMessage = '';
        this.submitted.emit({ ...this.form.value, identificationType: +this.form.value.identificationType });
    }
}
